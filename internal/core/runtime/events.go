...
// RuntimeEventType represents the category of a runtime event emitted by the
...
const (
	...
	EventTypeAssistantMessage RuntimeEventType = "assistant_message"
	...
	EventTypeRequestInput RuntimeEventType = "request_input"
)
